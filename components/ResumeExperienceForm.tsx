...
const ResumeExperienceSchema = CreateResumeSchema.pick({
  experience: true,
  summary: true,
});

export const ResumeExperienceForm = () => {
  ...
  const isCurrentJob = form.watch("experience");

  function onSubmit(data: z.infer<typeof ResumeExperienceSchema>) {
    console.log(data);
  ...
  return (
    resumeStore.currentStepIndex == 1 && (
      <Form {...form}>
